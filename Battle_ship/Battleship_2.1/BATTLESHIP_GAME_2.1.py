...
# BATTLESHIP_2.1 is updated for stats !!
# The stats are currently inaccurate.
...
def print_stats( hit , miss, turn):
	if turn == 0:
		turn = turn + 1
		
	hit_ratio = (hit / turn ) * 100
	miss_penalty = (miss / turn) * 100
	print ("hit ratio = %f %%") % hit_ratio
	print ("miss penalty = %f %%") % miss_penalty 
	return;
